...
이 저장소는 단순한 개인 홈페이지가 아니라 다음 역할을 함께 수행합니다.

- 개인 브랜딩 및 링크 허브
- 대표 프로젝트 쇼케이스
- VRChat 관련 활동 아카이브
- 외부 서비스(Booth, X, 개별 프로젝트)로 연결되는 진입점
...
- 대표 스크린샷/사진
- 외부 배포 중인 에셋 소개
- 실적이나 반응이 있었던 프로젝트 회고

반대로 깊은 개발 일지나 장문 블로그는 별도 저장소보다 이 허브에 요약 형태로 연결하는 편이 더 관리하기 쉽습니다.
...
- 장기적으로는 README뿐 아니라 실제 사이트 첫 화면도 "대표 프로젝트 3개 + 외부 링크 허브" 중심으로 더 선명하게 정리하면 좋습니다.
